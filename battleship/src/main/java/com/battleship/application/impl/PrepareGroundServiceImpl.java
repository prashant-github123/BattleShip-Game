...
public class PrepareGroundServiceImpl implements PrepareGroundService {
	 ...
	 */
	@Override
	public Player setShipCoodinatesForPlayer(String gameId, String playerId, String shipCoordinates) throws NoGameAvailableException, NoPlayerFoundException, NoGameAvailableException {
		...
		for (Player player : playerList) {
			if (player.getPlayerID() == Integer.valueOf(playerId)) {
				...
				Ship ship = new Ship();
				ship.setPositionCoordinates(genericUtil.convertToList(shipCoordinates));
